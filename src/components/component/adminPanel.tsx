...
export function AdminPanel(props: { user: any }) {
  return (
      ...
      <aside className="flex flex-col border-r bg-background">
        <div className="flex h-14 items-center justify-center border-b">
          ...
          >
            ...
            <span className="text-lg">NDRS</span>
          </Link>
        </div>
        <nav className="flex-1 overflow-auto">
          <ul className="grid gap-1 p-4 text-sm font-medium">
            <li>
              <Link
                href="/admin"
        ...
        <main className="flex-1 p-6">
          <div className="grid gap-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">Welcome back, {props.user.Username}!</h2>
              <p className="text-muted-foreground">
                Here is a quick overview of your dashboard.
              </p>
            </div>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Link href="/admin/disaster-alert">
                <Card>
                  <CardHeader>
                    <CardTitle>Disaster Alerts</CardTitle>
                    <CardDescription>Disaster in this world</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
            </div>
